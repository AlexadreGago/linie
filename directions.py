...
url="https://api.mapbox.com/directions/v5/mapbox/driving/{}?alternatives=false&geometries=geojson&overview=simplified&steps=false&access_token={}".format(str[:-1],token)
print(url)
